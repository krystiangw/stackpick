...
judge the business rather than the code. Baseline facts are as of 2026-09-07; later updates
are dated individually. Everything
...
| Item | Price | State on 2026-09-08 |
|---|---|---|
...
| Monitoring beta | free, no announced future price or end date | independent weekly HTTP checks and confirmed-change alerts; agent mention checks are a separate manual experiment without a fixed cadence |
| Integration pilot | $1500 each for the first two agreed pilots | approved introductory offer; two tasks, two tools, 24 planned attempts, one small fix and retest; not yet sold or executed |

Report and pilot prices live in `src/lib/billing/catalog.ts`. Its old monitoring rows are dormant,
...
- Competitive assessment, 2026-09-08: `docs/business-advantage-2026-09-08.md` compares
  current primary-source offers and inspected public reports. Lightsage already offers coding-agent
