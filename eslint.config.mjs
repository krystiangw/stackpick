...
const eslintConfig = defineConfig([
  ...
  ]),
  {
    ...
    // to strip a field from an object without mutating it. Warning on that trains people to
    // ignore the warning list, and a warning list nobody reads is where a real one hides.
    rules: {
