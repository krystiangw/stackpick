    ...
    <main className="mx-auto max-w-5xl px-6">
      ...
      <section className="py-12">
        ...
        <ol className="mt-5 flex flex-col gap-4">
          {[
            'llms.txt is scored, and we are not sure it is used. Across eighteen isolated agent runs in four categories, not one run cited it among its sources, and a ninety-day measurement published by Otterly in February 2026, at otterly.ai/blog/the-llms-txt-experiment, found 84 requests to it against 62,100 AI-bot visits. Our own evidence is weaker than it sounds, because a run can fetch a file without naming it in its report, so we have not removed the point. We have stopped pretending the point is worth more than one, and if you are choosing what to do first, this is not it.',
