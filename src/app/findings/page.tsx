...
const RESULTS: Result[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'It was repeated on a second tool the same day, five runs a category again, and the second tool reads none of the instructions on the machine it ran on: different vendor, different model, different contamination. The two survivors survive there too, and by more: registration by an agent +31 points (+29 among well known vendors, +24 among lesser known ones) and a live MCP endpoint +22 (+20 and +17). Documented key creation repeats its own pattern as well, +44 among well known vendors and minus five among the rest, which is what fame looks like when you split for it. A finding that holds across two tools with two different contaminations is about the vendors rather than about our machine.',
