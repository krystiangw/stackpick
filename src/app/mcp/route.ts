...
const FIND_TOOL = {
  ...
  description:
    ...
    'Routing a sentence to a category is by far the weakest thing here, and the number below is the one to plan around. Measured on 58 questions written before anybody read the rules and labelled before the first run: it answered 31 correctly, said nothing on 17 it should have answered, sent 4 to the wrong category and answered 6 that it should have refused. Put another way: it gave an answer to 39 of the 58, and 10 of those answers were wrong. An earlier held-out set of 59 questions has since been read and tuned against, so it no longer measures anything and this number replaces it; a set stops being held out the moment somebody fixes what it found. Silence is the common failure and means we could not read the question rather than that the category is empty. Name the category yourself when you know it.',
  inputSchema: {
    type: 'object',
    properties: {
